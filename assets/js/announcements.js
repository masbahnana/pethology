// Announcements Management for Pethology
...
export async function showEditAnnouncementModal(announcementId) {
  ...
  const announcements = await PethologyFirebaseService.getAnnouncements();
...
export async function handleAnnouncementSubmit(event) {
  ...
  try {
    ...
    if (mode === 'create') {
      ...
      await PethologyFirebaseService.createAnnouncement(announcementData);
      ...
      await PethologyFirebaseService.updateAnnouncement(announcementId, updates);
...
export async function deleteAnnouncement(announcementId) {
  ...
  try {
    await PethologyFirebaseService.deleteAnnouncement(announcementId);
...
export async function markAnnouncementAsRead(announcementId) {
  try {
    ...
    await PethologyFirebaseService.markAnnouncementAsRead(announcementId, user.id);
